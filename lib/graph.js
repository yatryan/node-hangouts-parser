      ...
      case 'month':
        ...
        for (var id in people) {
          if (people.hasOwnProperty(id)) {
            if (id === '_months' || id === '_years' || id === 'people') {
              continue;
            }
        ...
        fs.writeFileSync('web/months.json',JSON.stringify(returnObj, null, 2));
        Logger.info('Wrote months to web/months.json');
        break;
      default:
        // Year
        ...
        fs.writeFileSync('web/years.json',JSON.stringify(returnObj, null, 2));
        Logger.info('Wrote years to web/years.json');
        break;
    }
